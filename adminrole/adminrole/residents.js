...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Title and first name integration
    const titleSelect = document.getElementById('title');
    const firstNameInput = document.getElementById('firstName');
    
    if (titleSelect && firstNameInput) {
        // Store original first name for reference
        ...
        function updateNameDisplay() {
            ...
            // For example, showing a preview of the full name
        }
        
        titleSelect.addEventListener('change', updateNameDisplay);
